...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kMul, hipComplex, hipComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kDiv, hipComplex, hipComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kMul, hipDoubleComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kDiv, hipDoubleComplex, hipDoubleComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) {}
...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kSqrtBackwardWithDyX, hipComplex, hipComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) : unary_functor(attr0, attr1) {}
  UnaryFunctor<DeviceType::kCUDA, UnaryOp::kSqrt, hipComplex, hipComplex> unary_functor;
...
template<>
struct BinaryFunctor<DeviceType::kCUDA, BinaryOp::kSqrtBackwardWithDyX, hipDoubleComplex,
                     hipDoubleComplex> {
  OF_DEVICE_FUNC BinaryFunctor(Scalar attr0, Scalar attr1) : unary_functor(attr0, attr1) {}
  UnaryFunctor<DeviceType::kCUDA, UnaryOp::kSqrt, hipDoubleComplex, hipDoubleComplex> unary_functor;
...
SPECIALIZATION_COMPLEX_ARITHMETIC_BINARY_FUNCTOR(BinaryOp::kAdd, hipComplex, float);
SPECIALIZATION_COMPLEX_ARITHMETIC_BINARY_FUNCTOR(BinaryOp::kSub, hipComplex, float);
SPECIALIZATION_COMPLEX_ARITHMETIC_BINARY_FUNCTOR(BinaryOp::kAdd, hipDoubleComplex, double);
SPECIALIZATION_COMPLEX_ARITHMETIC_BINARY_FUNCTOR(BinaryOp::kSub, hipDoubleComplex, double);
...
SPECIALIZATION_COMPLEX_EQAUL_BINARY_FUNCTOR(hipComplex, float);
SPECIALIZATION_COMPLEX_EQAUL_BINARY_FUNCTOR(hipDoubleComplex, double);
...
SPECIALIZATION_COMPLEX_NOT_EQAUL_BINARY_FUNCTOR(hipComplex, float);
SPECIALIZATION_COMPLEX_NOT_EQAUL_BINARY_FUNCTOR(hipDoubleComplex, double);
